...
public class Blocks
{
    ...
    public static final BlockStairs purpur_stairs;
    ...
    public static final Block log_stripped1;
    public static final Block log_stripped2;
    ...
    static
    {
        ...
        else
        {
            ...
            purpur_stairs = (BlockStairs)getRegisteredBlock("purpur_stairs");
            ...
            crimson_stairs = getRegisteredBlock("crimson_stairs");
            warped_stairs = getRegisteredBlock("warped_stairs");
            log_stripped1 = getRegisteredBlock("log_stripped1");
            log_stripped2 = getRegisteredBlock("log_stripped2");
            lucky_block = getRegisteredBlock("lucky_block");
        }
    }
}
