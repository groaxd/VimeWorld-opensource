...
public class C01PacketEncryptionResponse implements Packet<INetHandlerLoginServer>
{
    ...
    public C01PacketEncryptionResponse(byte[] p_i19_1_, PublicKey p_i19_2_, byte[] p_i19_3_)
    {
        this.secretKeyEncrypted = p_i19_1_;
        this.verifyTokenEncrypted = CryptManager.encryptData(p_i19_2_, p_i19_3_);
    }
