...
public class ContainerRepair extends Container
{
    ...
    private boolean repairOutputUpdateDisabled;
    ...
    {
        if (!this.repairOutputUpdateDisabled)
        {
            int i = 0;
            int j = 1;
            int k = 1;
            ...
            else
            {
                ...
                if (itemstack2 != null)
                {
                    ...
                    if (itemstack1.isItemStackDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2))
                    {
                        ...
                        for (i5 = 0; k4 > 0 && i5 < itemstack2.stackSize; ++i5)
                        {
                    ...
                    else
                    {
                        ...
                        {
                            int j5 = ((Integer)iterator1.next()).intValue();
                            Enchantment enchantment = Enchantment.getEnchantmentById(j5);

                            if (enchantment != null)
                            {
                                int l5 = map.containsKey(Integer.valueOf(j5)) ? ((Integer)map.get(Integer.valueOf(j5))).intValue() : 0;
                                int l3 = ((Integer)map1.get(Integer.valueOf(j5))).intValue();
                                int i4;
                                ...
                                {
                                    int j4 = ((Integer)iterator.next()).intValue();

                                    if (j4 != j5 && !enchantment.canApplyTogether(Enchantment.getEnchantmentById(j4)))
                                    {
                                        flag1 = false;
                                        ++l1;
                                    }
                                ...
                                if (flag1)
                                {
                                    if (i4 > enchantment.getMaxLevel())
                                    {
                                        l3 = enchantment.getMaxLevel();
                                    }

                                    map.put(Integer.valueOf(j5), Integer.valueOf(l3));
                                    int i6 = 0;
                ...
                if (itemstack1 != null)
                {
                    int l4 = itemstack1.getRepairCost();

                    if (itemstack2 != null && l4 < itemstack2.getRepairCost())
                    {
                        l4 = itemstack2.getRepairCost();
                    }

                    l4 = l4 * 2 + 1;
                    itemstack1.setRepairCost(l4);
    ...
    public void updateProgressBar(int id, int data)
    {
        ...
        if (id == 1)
        {
            this.repairOutputUpdateDisabled = data == 1;
        }
    }
