...
{
    private static final ObfValue.OInteger OBFVAL_TvmPF = ObfValue.create(20);
    private static final ObfValue.OFloat OBFVAL_EeBDf = ObfValue.create(Float.MIN_VALUE);
    private static final ObfValue.OInteger OBFVAL_2Jzbq = ObfValue.create(16);
    private static final ObfValue.ODouble OBFVAL_JChBi = ObfValue.create(0.20000000298023224D);
    private static final ObfValue.OInteger OBFVAL_ljG4D = ObfValue.create(9);
    private static final ObfValue.OInteger OBFVAL_iRi8Y = ObfValue.create(6);
    private static final ObfValue.OInteger OBFVAL_yJi40 = ObfValue.create(3);
    private static final ObfValue.OInteger OBFVAL_n1FcM = ObfValue.create(4);
    private static final ObfValue.OInteger OBFVAL_loIEY = ObfValue.create(100);
    private static final ObfValue.OInteger OBFVAL_zMn0g = ObfValue.create(60);
    private static final ObfValue.ODouble OBFVAL_6knHK = ObfValue.create(0.5D);
    private static final ObfValue.OInteger OBFVAL_qQ22t = ObfValue.create(256);
    private static final ObfValue.OFloat OBFVAL_j8Evu = ObfValue.create(-1.0F);
    private static final ObfValue.OInteger OBFVAL_Rv15h = ObfValue.create(-99999999);
    private static final ObfValue.OInteger OBFVAL_vq6Ja = ObfValue.create(2);
    private static final ObfValue.OInteger OBFVAL_cPZ0p = ObfValue.create(Integer.MAX_VALUE);
    private static final ObfValue.OInteger OBFVAL_lNcLm = ObfValue.create(65535);
    private static final ObfValue.ODouble OBFVAL_STsFP = ObfValue.create(255.0D);
    private static final ObfValue.OInteger OBFVAL_9a4zg = ObfValue.create(10);
    private static final ObfValue.OInteger OBFVAL_IOQwx = ObfValue.create(5);
    private static final ObfValue.OFloat OBFVAL_KFIDb = ObfValue.create(-1.0E8F);
    private static final ObfValue.OInteger OBFVAL_rohPe = ObfValue.create(99);
    ...
    public EntityPlayerMP(MinecraftServer server, WorldServer worldIn, GameProfile profile, ItemInWorldManager interactionManager)
    {
        ...
        this.combinedHealth = OBFVAL_EeBDf.get();
        this.lastHealth = OBFVAL_KFIDb.get();
        this.lastFoodLevel = OBFVAL_Rv15h.get();
        this.wasHungry = true;
        this.lastExperience = OBFVAL_Rv15h.get();
        this.respawnInvulnerabilityTicks = OBFVAL_zMn0g.get();
        ...
        {
            int i = Math.max(OBFVAL_IOQwx.get(), server.getSpawnProtectionSize() - OBFVAL_iRi8Y.get());
            ...
            blockpos = worldIn.getTopSolidOrLiquidBlock(blockpos.add(this.rand.nextInt(i * OBFVAL_vq6Ja.get()) - i, 0, this.rand.nextInt(i * OBFVAL_vq6Ja.get()) - i));
        }
        ...
        while (!worldIn.getCollidingBoundingBoxes(this, this.getEntityBoundingBox()).isEmpty() && this.posY < OBFVAL_STsFP.get())
        {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        if (tagCompund.hasKey("playerGameType", OBFVAL_rohPe.get()))
        {
    ...
    public void onUpdate()
    {
        ...
        {
            int i = Math.min(this.destroyedItemsNetCache.size(), OBFVAL_cPZ0p.get());
            int[] aint = new int[i];
        ...
        if (!this.loadedChunks.isEmpty())
        {
            ...
            while (iterator1.hasNext() && ((List)list).size() < OBFVAL_9a4zg.get())
            {
                ChunkCoordIntPair chunkcoordintpair = (ChunkCoordIntPair)iterator1.next();

                if (chunkcoordintpair != null)
                {
                    if (this.worldObj.isBlockLoaded(new BlockPos(chunkcoordintpair.chunkXPos << OBFVAL_n1FcM.get(), 0, chunkcoordintpair.chunkZPos << OBFVAL_n1FcM.get())))
                    {
                        ...
                        {
                            list.add(chunk);
                            list1.addAll(((WorldServer)this.worldObj).getTileEntitiesIn(chunkcoordintpair.chunkXPos * OBFVAL_2Jzbq.get(), 0, chunkcoordintpair.chunkZPos * OBFVAL_2Jzbq.get(), chunkcoordintpair.chunkXPos * OBFVAL_2Jzbq.get() + OBFVAL_2Jzbq.get(), OBFVAL_qQ22t.get(), chunkcoordintpair.chunkZPos * OBFVAL_2Jzbq.get() + OBFVAL_2Jzbq.get()));
                            iterator1.remove();
                        }
                    }
                }
            ...
            if (!list.isEmpty())
            {
                if (list.size() == 1)
                {
                    this.playerNetServerHandler.sendPacket(new S21PacketChunkData((Chunk)list.get(0), true, OBFVAL_lNcLm.get()));
                }
                else
                {
    ...
    public void onUpdateEntity()
    {
        try
        {
            ...
            if (this.ticksExisted % OBFVAL_TvmPF.get() * OBFVAL_IOQwx.get() == 0 && !this.getStatFile().hasAchievementUnlocked(AchievementList.exploreAllBiomes))
            {
    ...
    public void travelToDimension(int dimensionId)
    {
        if (this.dimension == 1 && dimensionId == 1)
        {
            ...
            this.playerNetServerHandler.sendPacket(new S2BPacketChangeGameState(OBFVAL_n1FcM.get(), 0.0F));
        }
        else
        {
            ...
            this.lastExperience = -1;
            this.lastHealth = OBFVAL_j8Evu.get();
    ...
    public void wakeUpPlayer(boolean p_70999_1_, boolean updateWorldFlag, boolean setSpawn)
    {
        ...
        {
            this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(this, OBFVAL_vq6Ja.get()));
        }
    ...
    public void handleFalling(double p_71122_1_, boolean p_71122_3_)
    {
        ...
        int j = MathHelper.floor_double(this.posY - OBFVAL_JChBi.get());
    ...
    {
        this.currentWindowId = this.currentWindowId % OBFVAL_loIEY.get() + 1;
    }
    ...
    public void displayGUIChest(IInventory chestInventory)
    {
        ...
        if (chestInventory instanceof ILockableContainer)
        {
            ...
            {
                this.playerNetServerHandler.sendPacket(new S02PacketChat(new ChatComponentTranslation("container.isLocked", new Object[] {chestInventory.getDisplayName()}), (byte)OBFVAL_vq6Ja.get()));
    ...
    public void setEntityActionState(float p_110430_1_, float p_110430_2_, boolean p_110430_3_, boolean sneaking)
    {
        ...
        {
            if (p_110430_1_ >= OBFVAL_j8Evu.get() && p_110430_1_ <= 1.0F)
            {
                this.moveStrafing = p_110430_1_;
            }

            if (p_110430_2_ >= OBFVAL_j8Evu.get() && p_110430_2_ <= 1.0F)
            {
    ...
    {
        this.playerNetServerHandler.sendPacket(new S19PacketEntityStatus(this, (byte)OBFVAL_ljG4D.get()));
    ...
    public void setItemInUse(ItemStack stack, int duration)
    {
        ...
        {
            this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(this, OBFVAL_yJi40.get()));
        }
    }
    ...
    {
        this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(entityHit, OBFVAL_n1FcM.get()));
    }

    public void onEnchantmentCritical(Entity entityHit)
    {
        this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(entityHit, OBFVAL_IOQwx.get()));
    }
    ...
    public void setGameType(WorldSettings.GameType gameType)
    {
        ...
        this.playerNetServerHandler.sendPacket(new S2BPacketChangeGameState(OBFVAL_yJi40.get(), (float)gameType.getID()));
    ...
    public void handleClientSettings(C15PacketClientSettings packetIn)
    {
        ...
        this.getDataWatcher().updateObject(OBFVAL_9a4zg.get(), Byte.valueOf((byte)packetIn.getModelPartFlags()));
    }
    ...
    {
        return new BlockPos(this.posX, this.posY + OBFVAL_6knHK.get(), this.posZ);
    }
    ...
    static
    {
        ...
        ObfValue.endGeneration(new byte[] {(byte)17, (byte)2, (byte) - 94, (byte)91, (byte) - 27, (byte)73, (byte) - 9, (byte)119});
    }
}
