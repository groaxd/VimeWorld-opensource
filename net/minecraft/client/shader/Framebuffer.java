    ...
    public void createFramebuffer(int width, int height)
    {
        ...
        else
        {
            ...
            if (this.useDepth)
            {
                ...
                OpenGlHelper.glRenderbufferStorage(OpenGlHelper.GL_RENDERBUFFER, OpenGlHelper.GL_DEPTH24_STENCIL8, this.framebufferTextureWidth, this.framebufferTextureHeight);
                OpenGlHelper.glFramebufferRenderbuffer(OpenGlHelper.GL_FRAMEBUFFER, OpenGlHelper.GL_DEPTH_STENCIL_ATTACHMENT, OpenGlHelper.GL_RENDERBUFFER, this.depthBuffer);
            }
