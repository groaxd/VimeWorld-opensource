...
public class RenderChunk
{
        ...
        if (!regionrendercache.extendedLevelsInChunkCache())
        {
            ...
            for (BlockPosM blockposm : BlockPosM.getAllInBoxMutable(blockpos, blockpos1))
            {
                ...
                for (int j = 0; j < aenumworldblocklayer.length; ++j)
                {
                    ...
                    int i = enumworldblocklayer.ordinal();
                    ...
                    if (block.getRenderType() != -1)
                    {
                        ...
                        aboolean[i] |= blockrendererdispatcher.renderBlock(iblockstate, blockposm, regionrendercache, worldrenderer);
                    }
                }
            }
    ...
    {
        this.lockCompileTask.lock();
        ChunkCompileTaskGenerator chunkcompiletaskgenerator21;
        ...
        try
        {
            if (this.compileTask == null || this.compileTask.getStatus() != ChunkCompileTaskGenerator.Status.PENDING)
            {
                ...
                ChunkCompileTaskGenerator chunkcompiletaskgenerator3 = this.compileTask;
                ChunkCompileTaskGenerator chunkcompiletaskgenerator = chunkcompiletaskgenerator3;
                return chunkcompiletaskgenerator;
            }

            ChunkCompileTaskGenerator chunkcompiletaskgenerator1 = null;
            chunkcompiletaskgenerator21 = chunkcompiletaskgenerator1;
        }
        finally
        {
            this.lockCompileTask.unlock();
        ...
        return chunkcompiletaskgenerator21;
    }
