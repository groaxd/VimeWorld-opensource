...
public class BlockModelShapes
{
    ...
    private void registerAllBlocks()
    {
        ...
        this.registerBlockWithStateMapper(Blocks.log_stripped1, (new StateMap.Builder()).withName(BlockLogStripped1.VARIANT).withSuffix("_log_stripped").build());
        this.registerBlockWithStateMapper(Blocks.log_stripped2, (new StateMap.Builder()).withName(BlockLogStripped2.VARIANT).withSuffix("_log_stripped").build());
    }
}
