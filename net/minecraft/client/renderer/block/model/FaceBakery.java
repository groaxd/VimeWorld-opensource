...
public class FaceBakery
{
    ...
    {
        switch (FaceBakery.FaceBakery$FaceBakery$1.field_178400_a[facing.ordinal()])
        {
            case 1:
                if (Config.isShaders())
                {
    ...
    private void func_178407_a(Vector3f p_178407_1_, BlockPartRotation partRotation)
    {
        if (partRotation != null)
        {
            ...
            switch (FaceBakery.FaceBakery$FaceBakery$1.field_178399_b[partRotation.axis.ordinal()])
            {
                case 1:
    ...
    static final class FaceBakery$FaceBakery$1
    {
