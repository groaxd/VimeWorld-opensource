...
public class VertexFormat
{
    ...
    public VertexFormat()
    {
        ...
        this.uvOffsetsById = new int[] { -1, -1};
    ...
    public void clear()
    {
        ...
        this.offsets.clear();
        this.colorElementOffset = -1;
        Arrays.fill((int[])this.uvOffsetsById, (int) - 1);
        this.normalElementOffset = -1;
        this.nextOffset = 0;
    }
    ...
    public VertexFormat func_181721_a(VertexFormatElement p_181721_1_)
    {
        ...
        else
        {
            ...
            switch (p_181721_1_.getUsage())
            {
                ...
                case UV:
                    this.uvOffsetsById[p_181721_1_.getIndex()] = this.nextOffset;
            }
    ...
    {
        return this.uvOffsetsById[id] >= 0;
    }
