...
public class SoundHandler implements IResourceManagerReloadListener, ITickable
{
    ...
    private void loadSoundResource(ResourceLocation location, SoundList sounds)
    {
        ...
        for (final SoundList.SoundEntry soundlist$soundentry : sounds.getSoundList())
        {
            ...
            switch (null.$SwitchMap$net$minecraft$client$audio$SoundList$SoundEntry$Type[soundlist$soundentry.getSoundEntryType().ordinal()])
            {
                case 1:
                    ...
                    object = new SoundEventAccessor(new SoundPoolEntry(resourcelocation1, (double)soundlist$soundentry.getSoundEntryPitch(), (double)soundlist$soundentry.getSoundEntryVolume(), soundlist$soundentry.isStreaming()), soundlist$soundentry.getSoundEntryWeight());
                    break;
