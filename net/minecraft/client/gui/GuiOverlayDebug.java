...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List<String> call()
    {
        ...
        {
            return Lists.newArrayList(new String[] {"Minecraft 1.8.8 (VimeWorld: " + this.mc.getSession().getUsername() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[]{Integer.valueOf(blockpos.getX() & 15), Integer.valueOf(blockpos.getY() & 15), Integer.valueOf(blockpos.getZ() & 15)})});
        }
        else
        {
            ...
            String s1 = Texteria.tryGetServerId("");
            ...
            String s2 = Texteria.tryGetServerTime("");
