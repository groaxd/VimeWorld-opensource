...
public class Gui
{
    ...
    public void drawHollowSquare(int p_drawHollowSquare_1_, int p_drawHollowSquare_2_, int p_drawHollowSquare_3_, int p_drawHollowSquare_4_)
    {
        this.drawHorizontalLine(p_drawHollowSquare_1_, p_drawHollowSquare_1_ + p_drawHollowSquare_3_ - 1, p_drawHollowSquare_2_, p_drawHollowSquare_4_);
        this.drawHorizontalLine(p_drawHollowSquare_1_, p_drawHollowSquare_1_ + p_drawHollowSquare_3_ - 1, p_drawHollowSquare_2_ + p_drawHollowSquare_3_ - 1, p_drawHollowSquare_4_);
        this.drawVerticalLine(p_drawHollowSquare_1_, p_drawHollowSquare_2_, p_drawHollowSquare_2_ + p_drawHollowSquare_3_ - 1, p_drawHollowSquare_4_);
        this.drawVerticalLine(p_drawHollowSquare_1_ + p_drawHollowSquare_3_ - 1, p_drawHollowSquare_2_, p_drawHollowSquare_2_ + p_drawHollowSquare_3_ - 1, p_drawHollowSquare_4_);
    }
