...
public class Chunk
{
    ...
    private void updateSkylightNeighborHeight(int x, int z, int startY, int endY)
    {
        ...
        {
            if (this.worldObj.lightGuard.enabled && this.worldObj.lightGuard.batch)
            {
                startY = Math.max(startY, endY - 15);
            }
    ...
    private void relightBlock(int x, int y, int z)
    {
        ...
        if (j != i)
        {
            boolean flag = this.worldObj.lightGuard.startBatch(x + this.xPosition * 16, y, z + this.zPosition * 16);
            ...
            if (flag)
            {
                ...
                this.worldObj.lightGuard.endBatch();
            }
    ...
    public int getLightFor(EnumSkyBlock p_177413_1_, BlockPos pos)
    {
        ...
        {
            ExtendedBlockStorage extendedblockstorage = this.storageArrays[pos.getY() >> 4];
            return extendedblockstorage == null ? (pos.getY() >= this.heightMap[(pos.getX() & 15) << 4 | pos.getZ() & 15] ? p_177413_1_.defaultLightValue : 0) : (p_177413_1_ == EnumSkyBlock.SKY ? (this.worldObj.provider.getHasNoSky() ? 0 : extendedblockstorage.getExtSkylightValue(pos.getX() & 15, pos.getY() & 15, pos.getZ() & 15)) : extendedblockstorage.getExtBlocklightValue(pos.getX() & 15, pos.getY() & 15, pos.getZ() & 15));
        }
    }
    ...
    public void enqueueRelightChecks()
    {
        ...
        for (int k = 0; k < 8; ++k)
        {
            ...
            {
                BlockPos blockpos = blockpos$mutableblockpos.func_181079_c(i + i1, (l << 4) + k1, j + j1);
                ...
                if (this.storageArrays[l] == null && flag || this.storageArrays[l] != null && this.storageArrays[l].getBlockByExtId(i1, k1, j1).getMaterial() == Material.air)
                {
                    ...
                    {
                        BlockPos blockpos1 = blockpos$mutableblockpos1.func_181079_c(blockpos$mutableblockpos.getX() + enumfacing.getFrontOffsetX(), blockpos$mutableblockpos.getY() + enumfacing.getFrontOffsetY(), blockpos$mutableblockpos.getZ());
