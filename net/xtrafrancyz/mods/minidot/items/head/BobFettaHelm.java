...
public class BobFettaHelm extends BaseHelm
{
    ...
    public BobFettaHelm()
    {
        ...
        this.bone6.setTextureOffset(40, 19).addBox(-0.2606F, -7.0001F, 0.5F, 1, 1, 1, 0.0F);
        this.bone7 = new MModelRenderer(this);
        this.bone7.setRotationPoint(3.0F, 15.5F, -5.0F);
        this.setRotation(this.bone7, 0.0F, 0.0F, -1.6581F);
        this.bone7.setTextureOffset(3, 41).addBox(-0.7394F, -7.0001F, 0.5F, 1, 1, 1, 0.0F);
        ...
        this.bone3.setTextureOffset(40, 17).addBox(1.0F, -1.0F, 2.25F, 1, 1, 1, 0.0F);
        this.bone3.setTextureOffset(40, 6).addBox(1.0F, -8.0F, 2.25F, 1, 1, 1, 0.0F);
        ...
        this.bone31.setTextureOffset(21, 38).addBox(-0.75F, -2.0F, -0.75F, 1, 3, 1, 0.0F);
        this.bone31.setTextureOffset(37, 7).addBox(-0.25F, -2.0F, -0.95F, 1, 3, 1, 0.0F);
        this.bone31.setTextureOffset(30, 37).addBox(0.75F, -2.0F, -0.95F, 1, 3, 1, 0.0F);
        this.bone31.setTextureOffset(4, 36).addBox(1.0F, -2.0F, -0.95F, 1, 3, 1, -1.0E-4F);
        ...
        this.bone32.setTextureOffset(0, 36).addBox(-0.25F, -2.0F, -0.75F, 1, 3, 1, 0.0F);
        this.bone32.setTextureOffset(34, 30).addBox(-0.75F, -2.0F, -0.95F, 1, 3, 1, 0.0F);
        this.bone32.setTextureOffset(34, 4).addBox(-1.75F, -2.0F, -0.95F, 1, 3, 1, 0.0F);
        this.bone32.setTextureOffset(34, 0).addBox(-2.0F, -2.0F, -0.95F, 1, 3, 1, -1.0E-4F);
        this.bone32.setTextureOffset(32, 17).addBox(-0.1F, -2.0F, 0.0F, 1, 3, 1, 0.0F);
        this.bone32.setTextureOffset(28, 17).addBox(-0.1F, -2.0F, -0.25F, 1, 3, 1, -1.0E-4F);
        ...
        this.bone19.setTextureOffset(18, 0).addBox(-1.0F, -1.0F, 0.0F, 2, 4, 1, 0.0F);
        this.bone19.setTextureOffset(33, 40).addBox(-0.5F, -0.7F, 0.1F, 1, 1, 1, 0.0F);
        this.bone19.setTextureOffset(0, 40).addBox(-0.5F, 0.57F, 0.1F, 1, 1, 1, 0.0F);
        this.bone19.setTextureOffset(25, 39).addBox(-0.5F, 1.8F, 0.1F, 1, 1, 1, 0.0F);
        this.bone21 = new MModelRenderer(this);
        this.bone21.setRotationPoint(3.95F, 19.25F, -3.5F);
        this.bone21.setTextureOffset(10, 21).addBox(0.0583F, -2.96F, 2.3781F, 1, 1, 2, 0.0F);
        ...
        this.bone23.setTextureOffset(38, 15).addBox(-0.9583F, 0.94F, 3.3781F, 1, 1, 1, 0.0F);
        this.bone24 = new MModelRenderer(this);
        this.bone24.setRotationPoint(-4.15F, 19.25F, -3.5F);
        this.bone24.setTextureOffset(28, 0).addBox(-1.0583F, -2.96F, 2.3781F, 1, 2, 2, -0.1F);
        ...
        this.bone27.setTextureOffset(38, 4).addBox(-2.1272F, -5.88F, 3.3781F, 1, 1, 1, -0.001F);
        this.bone15 = new MModelRenderer(this);
        this.bone15.setRotationPoint(-0.63F, -0.2707F, -0.75F);
        this.bone27.addChild(this.bone15);
        this.setRotation(this.bone15, 0.0F, 0.0F, -0.0873F);
        this.bone15.setTextureOffset(28, 4).addBox(5.6242F, -0.5005F, 1.2281F, 1, 1, 1, 0.0F);
        this.bone20 = new MModelRenderer(this);
        this.bone20.setRotationPoint(-0.63F, -0.2707F, 0.45F);
        this.bone27.addChild(this.bone20);
        this.setRotation(this.bone20, 0.0F, 0.0F, -0.0873F);
        this.bone20.setTextureOffset(20, 25).addBox(5.6242F, -0.5005F, 1.2281F, 1, 1, 1, 0.0F);
        this.bone28 = new MModelRenderer(this);
        this.bone28.setRotationPoint(-0.63F, -0.2707F, 1.65F);
        this.bone27.addChild(this.bone28);
        this.setRotation(this.bone28, 0.0F, 0.0F, -0.0873F);
        this.bone28.setTextureOffset(4, 22).addBox(5.6242F, -0.5005F, 1.2281F, 1, 1, 1, 0.0F);
        this.bone29 = new MModelRenderer(this);
        this.bone29.setRotationPoint(-0.63F, -0.2707F, 2.85F);
        this.bone27.addChild(this.bone29);
        this.setRotation(this.bone29, 0.0F, 0.0F, -0.0873F);
        this.bone29.setTextureOffset(0, 22).addBox(5.6242F, -0.5005F, 1.2281F, 1, 1, 1, 0.0F);
        this.bone30 = new MModelRenderer(this);
        this.bone30.setRotationPoint(-0.63F, -0.2707F, 4.05F);
        this.bone27.addChild(this.bone30);
        this.setRotation(this.bone30, 0.0F, 0.0F, -0.0873F);
        this.bone30.setTextureOffset(14, 21).addBox(5.6242F, -0.5005F, 1.2281F, 1, 1, 1, 0.0F);
        this.bone34 = new MModelRenderer(this);
        this.bone34.setRotationPoint(-0.63F, -0.2707F, 5.25F);
        this.bone27.addChild(this.bone34);
        this.setRotation(this.bone34, 0.0F, 0.0F, -0.0873F);
        this.bone34.setTextureOffset(4, 16).addBox(5.6242F, -0.5005F, 1.2281F, 1, 1, 1, 0.0F);
        this.bb_main = new MModelRenderer(this);
        this.bb_main.setRotationPoint(0.0F, 24.0F, 0.0F);
        this.bb_main.setTextureOffset(0, 0).addBox(-4.0F, -11.0F, -4.0F, 8, 8, 8, 0.0F);
        this.setTexture(new ResourceLocation("minidot", "head/bobfettahelm.png"));
    }
