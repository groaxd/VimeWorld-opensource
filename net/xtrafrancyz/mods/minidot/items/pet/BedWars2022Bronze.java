...
public class BedWars2022Bronze extends BasePet
{
    ...
    private final MModelRenderer Emotion4;
    ...
    public BedWars2022Bronze()
    {
        ...
        this.Begin.cubeList.add(new ModelBox(this.Begin, 30, 33, -2.0F, -1.0F, -5.0F, 2, 1, 2, 0.0F, false));
        this.Begin.cubeList.add(new ModelBox(this.Begin, 0, 38, -2.0F, -1.0F, 3.0F, 2, 1, 2, 0.0F, false));
        ...
        this.Pillow.cubeList.add(new ModelBox(this.Pillow, 52, 42, -2.0F, -0.5F, -4.0F, 4, 1, 8, 0.0F, false));
        ...
        this.End.cubeList.add(new ModelBox(this.End, 24, 40, 0.0F, -1.0F, 3.0F, 2, 1, 2, 0.0F, false));
        this.End.cubeList.add(new ModelBox(this.End, 30, 30, 0.0F, -1.0F, -5.0F, 2, 1, 2, 0.0F, false));
        ...
        this.Persona.setRotationPoint(0.0F, -16.5F, 0.0F);
        this.root.addChild(this.Persona);
        this.Persona.cubeList.add(new ModelBox(this.Persona, 0, 52, -3.5F, -6.5F, -2.0F, 7, 7, 4, 0.0F, false));
        this.Emotion1 = new MModelRenderer(this);
        this.Emotion1.setRotationPoint(0.0F, -3.0F, -2.1F);
        this.Persona.addChild(this.Emotion1);
        this.Emotion1.cubeList.add(new ModelBox(this.Emotion1, 22, 58, -3.0F, -2.5F, 0.0F, 6, 5, 0, 0.0F, false));
        this.Emotion2 = new MModelRenderer(this);
        this.Emotion2.setRotationPoint(0.0F, -3.0F, -1.9F);
        this.Persona.addChild(this.Emotion2);
        this.Emotion2.cubeList.add(new ModelBox(this.Emotion2, 0, 5, -3.0F, -2.5F, 0.0F, 6, 5, 0, 0.0F, false));
        this.Emotion3 = new MModelRenderer(this);
        this.Emotion3.setRotationPoint(0.0F, -3.0F, -1.9F);
        this.Persona.addChild(this.Emotion3);
        this.Emotion3.cubeList.add(new ModelBox(this.Emotion3, 38, 42, -3.0F, -2.5F, 0.0F, 6, 5, 0, 0.0F, false));
        this.Emotion4 = new MModelRenderer(this);
        this.Emotion4.setRotationPoint(0.0F, -3.0F, -1.9F);
        this.Persona.addChild(this.Emotion4);
        this.Emotion4.cubeList.add(new ModelBox(this.Emotion4, 0, 0, -3.0F, -2.5F, 0.0F, 6, 5, 0, 0.0F, false));
        this.LeftEar = new MModelRenderer(this);
        this.LeftEar.setRotationPoint(2.0F, -6.5F, 0.0F);
        this.Persona.addChild(this.LeftEar);
        this.LeftEar.cubeList.add(new ModelBox(this.LeftEar, 0, 41, -1.0F, -2.0F, -0.5F, 2, 2, 1, 0.0F, false));
        this.RightEar = new MModelRenderer(this);
        this.RightEar.setRotationPoint(-2.0F, -6.5F, 0.0F);
        this.Persona.addChild(this.RightEar);
        this.RightEar.cubeList.add(new ModelBox(this.RightEar, 42, 14, -1.0F, -2.0F, -0.5F, 2, 2, 1, 0.0F, false));
        this.LeftHand = new MModelRenderer(this);
        this.LeftHand.setRotationPoint(3.5F, -2.5F, 0.0F);
        this.Persona.addChild(this.LeftHand);
        this.LeftHand.cubeList.add(new ModelBox(this.LeftHand, 0, 26, 0.0F, -1.0F, -1.0F, 3, 2, 2, 0.0F, false));
        this.RightHand = new MModelRenderer(this);
        this.RightHand.setRotationPoint(-3.5F, -2.5F, 0.0F);
        this.Persona.addChild(this.RightHand);
        this.RightHand.cubeList.add(new ModelBox(this.RightHand, 0, 19, -3.0F, -1.0F, -1.0F, 3, 2, 2, 0.0F, false));
        this.LeftLeg = new MModelRenderer(this);
        this.LeftLeg.setRotationPoint(1.8F, 0.5F, 0.0F);
        this.Persona.addChild(this.LeftLeg);
        this.LeftLeg.cubeList.add(new ModelBox(this.LeftLeg, 0, 30, -1.0F, 0.0F, -1.0F, 2, 2, 2, 0.0F, false));
        this.RightLeg = new MModelRenderer(this);
        this.RightLeg.setRotationPoint(-1.8F, 0.5F, 0.0F);
        this.Persona.addChild(this.RightLeg);
        this.RightLeg.cubeList.add(new ModelBox(this.RightLeg, 30, 26, -1.0F, 0.0F, -1.0F, 2, 2, 2, 0.0F, false));
        this.Helmet = new MModelRenderer(this);
        this.Helmet.setRotationPoint(0.0F, -5.5F, 0.0F);
        this.setRotation(this.Helmet, -0.0873F, 0.0F, 0.0F);
        this.Persona.addChild(this.Helmet);
        this.Helmet.cubeList.add(new ModelBox(this.Helmet, 52, 0, -4.0F, -2.0F, -2.5F, 8, 4, 5, 0.0F, false));
        this.bone4 = new MModelRenderer(this);
        this.bone4.setRotationPoint(0.5F, -9.75F, 0.0F);
        this.Persona.addChild(this.bone4);
        this.bone4.cubeList.add(new ModelBox(this.bone4, 54, 22, 0.0F, -8.9361F, -0.953F, 0, 11, 2, 0.0F, false));
        this.bone4.cubeList.add(new ModelBox(this.bone4, 0, 14, -0.5F, -2.1361F, -1.953F, 1, 1, 4, -0.2F, false));
        this.Pedestal = new MModelRenderer(this);
        this.Pedestal.setRotationPoint(0.0F, -5.2F, 0.0F);
        this.root.addChild(this.Pedestal);
        this.Pedestal.cubeList.add(new ModelBox(this.Pedestal, 52, 51, -5.0F, -5.3F, -7.0F, 10, 5, 2, 0.0F, false));
        ...
        super.setTexture(new ResourceLocation("minidot", "pets/bedwars2022bronze.png"));
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/bedwars2022bronze_animation.json"));
    ...
    {
        return "\u0411\u0440\u043e\u043d\u0437\u043e\u0432\u0430\u044f \u043a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2022";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u0442\u0440\u0435\u0442\u044c\u0435 \u043c\u0435\u0441\u0442\u043e \u0432 \u0442\u0443\u0440\u043d\u0438\u0440\u0435 " + EnumChatFormatting.GREEN + "BedWars Hard [\u041b\u0435\u0442\u043e 2022]");
    }
}
