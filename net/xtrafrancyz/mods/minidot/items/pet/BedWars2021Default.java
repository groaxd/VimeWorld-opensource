...
public class BedWars2021Default extends BasePet
{
    ...
    public BedWars2021Default()
    {
        ...
        this.setRotation(this.Body, -0.0436F, -0.1309F, 0.0436F);
        ...
        this.Scarf.setRotationPoint(0.0F, 4.5F, -3.5F);
        ...
        this.Sword.setRotationPoint(-8.1F, -3.9F, -3.9F);
        this.setRotation(this.Sword, 0.5236F, 0.7418F, 0.0F);
        ...
        this.RightLeg.setRotationPoint(-2.3F, -16.5F, -0.5F);
        ...
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/BedWars2021Default.animation.json"));
        this.anim = bbanimationloader.mustGet("animation.tournament.scarf", this);
        this.setTexture(new ResourceLocation("minidot", "pets/BedWars2021Default.png"));
    }
    ...
    {
        return "\u041a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2021";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u0443\u0447\u0430\u0441\u0442\u0438\u0435 \u0432 \u0442\u0443\u0440\u043d\u0438\u0440\u0435 " + EnumChatFormatting.AQUA + "BedWars Hard [\u0417\u0438\u043c\u0430 2021]");
    }
}
