...
public class BedWars2021Organizer extends BasePet
{
    ...
    private final MModelRenderer IceShards;
    private final MModelRenderer twoShard;
    private final MModelRenderer oneShard;
    private final IAnimation anim;

    public BedWars2021Organizer()
    {
        ...
        this.LeftHand.setRotationPoint(-5.9F, 1.95F, 0.15F);
        ...
        this.RightHand.setRotationPoint(5.3F, 1.8F, -0.8F);
        ...
        this.LeftLeg.setRotationPoint(2.6F, -15.8F, 0.2F);
        ...
        this.RightLeg.setRotationPoint(-2.3F, -15.75F, 0.75F);
        this.setRotation(this.RightLeg, 0.0F, 0.0F, 0.3218F);
        ...
        this.IceShards = new MModelRenderer(this);
        this.IceShards.setRotationPoint(-5.0F, -7.5F, -0.5F);
        this.Main.addChild(this.IceShards);
        this.twoShard = new MModelRenderer(this);
        this.twoShard.setRotationPoint(-10.5F, -16.5F, 0.5F);
        this.IceShards.addChild(this.twoShard);
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 81, 27, -1.5F, -1.5F, -0.5F, 3, 3, 1, 0.0F, false));
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 69, 24, -5.0F, -0.5F, -0.5F, 10, 1, 1, 9.0E-4F, false));
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 70, 32, -0.5F, -5.0F, -0.5F, 1, 10, 1, 9.0E-4F, false));
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 74, 32, -4.0F, -1.5F, -0.5F, 1, 3, 1, -9.0E-4F, false));
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 74, 36, -1.5F, -4.0F, -0.5F, 3, 1, 1, -9.0E-4F, false));
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 74, 36, -1.5F, 3.0F, -0.5F, 3, 1, 1, -9.0E-4F, false));
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 74, 32, 3.0F, -1.5F, -0.5F, 1, 3, 1, -9.0E-4F, false));
        this.twoShard.cubeList.add(new ModelBox(this.twoShard, 72, 30, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0.2F, false));
        this.oneShard = new MModelRenderer(this);
        this.oneShard.setRotationPoint(18.5F, -16.5F, 0.5F);
        this.IceShards.addChild(this.oneShard);
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 81, 27, -1.5F, -1.5F, -0.5F, 3, 3, 1, 0.0F, false));
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 69, 24, -5.0F, -0.5F, -0.5F, 10, 1, 1, 9.0E-4F, false));
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 70, 32, -0.5F, -5.0F, -0.5F, 1, 10, 1, 9.0E-4F, false));
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 74, 32, -4.0F, -1.5F, -0.5F, 1, 3, 1, -9.0E-4F, false));
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 74, 36, -1.5F, -4.0F, -0.5F, 3, 1, 1, -9.0E-4F, false));
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 74, 36, -1.5F, 3.0F, -0.5F, 3, 1, 1, -9.0E-4F, false));
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 74, 32, 3.0F, -1.5F, -0.5F, 1, 3, 1, -9.0E-4F, false));
        this.oneShard.cubeList.add(new ModelBox(this.oneShard, 72, 30, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0.2F, false));
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/BedWars2021Organizer.animation.json"));
        this.anim = bbanimationloader.mustGet("animation.tournament.scarf", this);
        this.setTexture(new ResourceLocation("minidot", "pets/BedWars2021Organizer.png"));
    }
    ...
    {
        return "\u041b\u0435\u0434\u044f\u043d\u0430\u044f \u043a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2021";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u043e\u0440\u0433\u0430\u043d\u0438\u0437\u0430\u0446\u0438\u044e \u0442\u0443\u0440\u043d\u0438\u0440\u0430 " + EnumChatFormatting.AQUA + "BedWars Hard [\u0417\u0438\u043c\u0430 2021]");
    }
}
