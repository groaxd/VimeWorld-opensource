...
public class BedWars2022Stone extends BasePet
{
    ...
    public BedWars2022Stone()
    {
        ...
        super.setTexture(new ResourceLocation("minidot", "pets/bedwars2022stone.png"));
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/bedwars2022stone_animation.json"));
    ...
    {
        return "\u041a\u0430\u043c\u0435\u043d\u043d\u0430\u044f \u043a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2022";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u043f\u043e\u043f\u0430\u0434\u0430\u043d\u0438\u0435 \u0432 \u0442\u0443\u0440\u043d\u0438\u0440\u043d\u0443\u044e \u0441\u0435\u0442\u043a\u0443 " + EnumChatFormatting.GREEN + "BedWars Hard [\u041b\u0435\u0442\u043e 2022]");
    }
}
