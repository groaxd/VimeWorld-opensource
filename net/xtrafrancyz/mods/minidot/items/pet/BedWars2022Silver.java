...
public class BedWars2022Silver extends BasePet
{
    ...
    public BedWars2022Silver()
    {
        ...
        this.Sword.setRotationPoint(0.5F, 1.7139F, 2.047F);
        this.setRotation(this.Sword, 0.0F, -1.5708F, -0.9599F);
        this.Persona.addChild(this.Sword);
        this.Sword.cubeList.add(new ModelBox(this.Sword, 82, 18, 0.0F, -6.4F, -1.0F, 0, 11, 2, 0.0F, false));
        this.Sword.cubeList.add(new ModelBox(this.Sword, 112, 27, -0.5F, 0.4F, -2.0F, 1, 1, 4, -0.2F, false));
        ...
        this.Helmet.setRotationPoint(0.0F, -2.5F, 0.0F);
        ...
        this.bone3.setRotationPoint(5.5F, 2.0F, 0.0F);
        this.Persona.addChild(this.bone3);
        this.bone3.cubeList.add(new ModelBox(this.bone3, 0, 84, 0.0F, -7.0F, -4.0F, 0, 2, 8, 0.0F, false));
        this.bone3.cubeList.add(new ModelBox(this.bone3, 0, 73, 0.0F, -6.0F, -1.0F, 0, 8, 2, 0.0F, false));
        ...
        super.setTexture(new ResourceLocation("minidot", "pets/bedwars2022silver.png"));
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/bedwars2022silver_animation.json"));
    ...
    {
        return "\u0421\u0435\u0440\u0435\u0431\u0440\u044f\u043d\u0430\u044f \u043a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2022";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u0432\u0442\u043e\u0440\u043e\u0435 \u043c\u0435\u0441\u0442\u043e \u0432 \u0442\u0443\u0440\u043d\u0438\u0440\u0435 " + EnumChatFormatting.GREEN + "BedWars Hard [\u041b\u0435\u0442\u043e 2022]");
    }
}
