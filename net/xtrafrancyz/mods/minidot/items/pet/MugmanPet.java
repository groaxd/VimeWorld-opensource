...
public class MugmanPet extends BasePet
{
    ...
    public MugmanPet()
    {
        ...
        this.bone.setTextureOffset(52, 42).addBox(1.0F, -4.0F, 0.0F, 2, 4, 2, 0.0F);
        this.bone2 = new MModelRenderer(this);
        this.bone2.setRotationPoint(7.0F, -3.0F, 1.0F);
        this.Legs.addChild(this.bone2);
        this.bone2.setTextureOffset(44, 51).addBox(-1.0F, -4.0F, 0.0F, 2, 4, 2, 0.0F);
        this.bone3 = new MModelRenderer(this);
        this.bone3.setRotationPoint(3.0F, 0.0F, 0.0F);
        this.Legs.addChild(this.bone3);
        this.bone3.setTextureOffset(28, 51).addBox(-3.0F, -8.0F, 0.0F, 4, 1, 4, 0.0F);
        this.bone3.setTextureOffset(16, 50).addBox(2.0F, -8.0F, 0.0F, 4, 1, 4, 0.0F);
        ...
        this.bone7.setTextureOffset(22, 55).addBox(-9.0F, -14.0F, 1.0F, 2, 3, 2, 0.0F);
        this.bone7.setTextureOffset(14, 55).addBox(10.0F, -14.0F, 1.0F, 2, 3, 2, 0.0F);
        ...
        this.Head.setTextureOffset(14, 40).addBox(9.0F, -22.0F, 1.0F, 4, 2, 2, 0.0F);
        this.Head.setTextureOffset(52, 51).addBox(11.0F, -25.0F, 1.0F, 2, 3, 2, 0.0F);
        this.Head.setTextureOffset(14, 36).addBox(9.0F, -27.0F, 1.0F, 4, 2, 2, 0.0F);
        this.Head.setTextureOffset(0, 36).addBox(6.0F, -34.0F, 6.0F, 2, 6, 2, 0.0F);
        this.bone9 = new MModelRenderer(this);
        this.bone9.setRotationPoint(3.0F, 0.0F, 0.0F);
        this.Legs.addChild(this.bone9);
        this.bone9.setTextureOffset(44, 8).addBox(-1.0F, -25.0F, -7.0F, 5, 3, 3, 0.0F);
        this.setTexture(new ResourceLocation("minidot", "pets/mugman.png"));
    }
