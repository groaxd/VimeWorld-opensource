...
public class BedWars2021Stone extends BasePet
{
    ...
    private final MModelRenderer Stones;
    private final MModelRenderer MainStone;
    private final MModelRenderer bone20;
    private final IAnimation anim;

    public BedWars2021Stone()
    {
        ...
        this.Sword.setRotationPoint(-2.4249F, -3.6513F, 3.2831F);
        this.setRotation(this.Sword, 2.4435F, -1.5708F, 0.0F);
        ...
        this.setRotation(this.bone10, 0.0F, -0.0436F, -0.0436F);
        this.Scarf.addChild(this.bone10);
        this.bone10.cubeList.add(new ModelBox(this.bone10, 50, 8, -2.8372F, -1.2772F, -1.0422F, 6, 2, 2, 0.0F, false));
        this.bone3 = new MModelRenderer(this);
        this.bone3.setRotationPoint(-3.945F, -5.4466F, 0.2309F);
        this.setRotation(this.bone3, 0.0F, 0.3927F, 0.3927F);
        this.Scarf.addChild(this.bone3);
        this.bone3.cubeList.add(new ModelBox(this.bone3, 16, 51, -1.9276F, -0.9044F, -0.568F, 5, 2, 2, 0.0F, false));
        this.bone11 = new MModelRenderer(this);
        this.bone11.setRotationPoint(4.682F, -4.704F, 2.0329F);
        this.setRotation(this.bone11, 0.0F, -1.0472F, -0.1745F);
        ...
        this.bone14.setRotationPoint(-4.9F, -5.35F, 4.9F);
        this.setRotation(this.bone14, -0.1745F, 0.3927F, 0.0F);
        ...
        this.bone15.setRotationPoint(-5.3F, -6.1F, 2.0F);
        this.setRotation(this.bone15, 0.0F, -0.4363F, 0.2182F);
        this.Scarf.addChild(this.bone15);
        this.bone15.cubeList.add(new ModelBox(this.bone15, 60, 37, -1.0F, -0.8068F, -1.0518F, 2, 2, 2, 0.0F, false));
        ...
        this.LeftHand.setRotationPoint(-5.95F, 1.6F, -2.1F);
        this.setRotation(this.LeftHand, 0.9599F, -1.8326F, -0.0436F);
        ...
        this.bone19.setRotationPoint(-3.0F, 0.9F, 0.0F);
        this.setRotation(this.bone19, 0.0F, 0.0F, -1.0908F);
        this.LeftHand.addChild(this.bone19);
        this.bone19.cubeList.add(new ModelBox(this.bone19, 48, 45, 1.9126F, 2.4389F, -0.6048F, 4, 2, 1, 0.0F, true));
        ...
        this.bone4.cubeList.add(new ModelBox(this.bone4, 48, 45, -2.1923F, -2.4902F, -0.6057F, 7, 2, 1, 9.0E-4F, false));
        this.RightHand = new MModelRenderer(this);
        this.RightHand.setRotationPoint(5.25F, 1.55F, -1.6F);
        this.setRotation(this.RightHand, 0.8727F, 1.8762F, 0.1309F);
        ...
        this.bone18.setRotationPoint(3.0F, 0.9F, 0.0F);
        this.setRotation(this.bone18, 0.0F, 0.0F, 1.1345F);
        this.RightHand.addChild(this.bone18);
        this.bone18.cubeList.add(new ModelBox(this.bone18, 52, 29, -6.7551F, 2.2511F, -0.1523F, 6, 2, 1, -9.0E-4F, true));
        ...
        this.LeftLeg.setRotationPoint(2.6F, -15.8F, 0.6F);
        ...
        this.Stones = new MModelRenderer(this);
        this.Stones.setRotationPoint(0.0F, -7.5F, -0.5F);
        this.Main.addChild(this.Stones);
        this.MainStone = new MModelRenderer(this);
        this.MainStone.setRotationPoint(0.25F, -13.75F, -6.75F);
        this.Stones.addChild(this.MainStone);
        this.MainStone.cubeList.add(new ModelBox(this.MainStone, 74, 28, -0.1F, -0.9F, -0.05F, 1, 1, 1, -0.1F, false));
        this.MainStone.cubeList.add(new ModelBox(this.MainStone, 79, 28, 0.05F, -0.05F, -0.9F, 1, 1, 1, -0.1F, false));
        this.MainStone.cubeList.add(new ModelBox(this.MainStone, 84, 28, -0.9F, -0.25F, -1.0F, 1, 1, 1, 0.0F, false));
        this.MainStone.cubeList.add(new ModelBox(this.MainStone, 69, 30, -1.0F, -0.1F, -0.05F, 1, 1, 1, -0.1F, false));
        this.bone20 = new MModelRenderer(this);
        this.bone20.setRotationPoint(0.5F, 0.5F, -0.5F);
        this.MainStone.addChild(this.bone20);
        this.bone20.cubeList.add(new ModelBox(this.bone20, 69, 28, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.2F, false));
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/BedWars2021Stone.animation.json"));
        this.anim = bbanimationloader.mustGet("animation.tournament.scarf", this);
        this.setTexture(new ResourceLocation("minidot", "pets/BedWars2021Stone.png"));
    }
    ...
    {
        return "\u041a\u0430\u043c\u0435\u043d\u043d\u0430\u044f \u043a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2021";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u043f\u043e\u043f\u0430\u0434\u0430\u043d\u0438\u0435 \u0432 \u0442\u0443\u0440\u043d\u0438\u0440\u043d\u0443\u044e \u0441\u0435\u0442\u043a\u0443 " + EnumChatFormatting.AQUA + "BedWars Hard [\u0417\u0438\u043c\u0430 2021]");
    }
}
