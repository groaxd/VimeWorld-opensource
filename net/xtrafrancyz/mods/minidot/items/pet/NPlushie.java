...
public class NPlushie extends BasePet
{
    ...
    public NPlushie()
    {
        ...
        this.bone17.setRotationPoint(0.0F, -1.6F, -3.05F);
        this.setRotation(this.bone17, -0.4363F, 0.0F, 0.0F);
        this.bone3.addChild(this.bone17);
        this.bone17.cubeList.add(new ModelBox(this.bone17, 10, 0, -3.45F, -10.75F, -1.5F, 6, 2, 5, -0.3F, false));
        this.bone17.cubeList.add(new ModelBox(this.bone17, 20, 9, -3.65F, -9.75F, -2.5F, 4, 1, 2, -0.3F, false));
        this.bone17.cubeList.add(new ModelBox(this.bone17, 22, 9, -0.25F, -9.75F, -2.5F, 3, 1, 2, -0.3F, false));
        ...
        super.setTexture(new ResourceLocation("minidot", "pets/nplushie.png"));
    }
