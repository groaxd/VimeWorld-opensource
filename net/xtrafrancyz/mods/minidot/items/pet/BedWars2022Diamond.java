...
public class BedWars2022Diamond extends BasePet
{
    private final MModelRenderer root;
    private final MModelRenderer Bed;
    private final MModelRenderer Begin2;
    private final MModelRenderer Prebegin;
    private final MModelRenderer Pillow;
    private final MModelRenderer End;
    private final MModelRenderer prend;
    ...
    public BedWars2022Diamond()
    {
        this.textureWidth = 128;
        this.textureHeight = 128;
        this.root = new MModelRenderer(this);
        this.Bed = new MModelRenderer(this);
        this.Bed.setRotationPoint(1.0F, -23.0F, 0.0F);
        this.root.addChild(this.Bed);
        this.Begin2 = new MModelRenderer(this);
        this.Begin2.setRotationPoint(-9.0F, -3.0F, 0.0F);
        this.Bed.addChild(this.Begin2);
        this.Begin2.cubeList.add(new ModelBox(this.Begin2, 24, 42, -1.0F, -4.0F, -5.0F, 2, 6, 10, 0.0F, false));
        this.Begin2.cubeList.add(new ModelBox(this.Begin2, 30, 29, -1.0F, 2.0F, -5.0F, 2, 1, 2, 0.0F, false));
        this.Begin2.cubeList.add(new ModelBox(this.Begin2, 30, 32, -1.0F, 2.0F, 3.0F, 2, 1, 2, 0.0F, false));
        this.Prebegin = new MModelRenderer(this);
        this.Prebegin.setRotationPoint(-5.0F, -3.0F, 0.0F);
        this.Bed.addChild(this.Prebegin);
        this.Prebegin.cubeList.add(new ModelBox(this.Prebegin, 0, 38, -3.0F, -2.0F, -5.0F, 7, 4, 10, 0.0F, false));
        this.Pillow = new MModelRenderer(this);
        this.Pillow.setRotationPoint(-6.0F, -5.5F, 0.0F);
        this.Bed.addChild(this.Pillow);
        this.Pillow.cubeList.add(new ModelBox(this.Pillow, 52, 0, -2.0F, -0.5F, -4.0F, 4, 1, 8, 0.0F, false));
        this.End = new MModelRenderer(this);
        this.End.setRotationPoint(6.0F, -3.0F, 0.0F);
        this.Bed.addChild(this.End);
        this.End.cubeList.add(new ModelBox(this.End, 38, 48, 0.0F, -3.0F, -5.0F, 2, 5, 10, 0.0F, false));
        this.End.cubeList.add(new ModelBox(this.End, 0, 38, 0.0F, 2.0F, 3.0F, 2, 1, 2, 0.0F, false));
        this.End.cubeList.add(new ModelBox(this.End, 30, 26, 0.0F, 2.0F, -5.0F, 2, 1, 2, 0.0F, false));
        this.prend = new MModelRenderer(this);
        this.prend.setRotationPoint(3.0F, -3.0F, 0.0F);
        this.Bed.addChild(this.prend);
        this.prend.cubeList.add(new ModelBox(this.prend, 30, 28, -4.0F, -2.0F, -5.0F, 7, 4, 10, 0.0F, false));
        this.Persona = new MModelRenderer(this);
        this.Persona.setRotationPoint(0.0F, -15.5F, 0.0F);
        ...
        this.Emotion2.setRotationPoint(0.0F, 0.0F, -2.05F);
        ...
        this.Emotion3.setRotationPoint(0.0F, 0.0F, -2.025F);
        ...
        this.Pedestal.cubeList.add(new ModelBox(this.Pedestal, 0, 63, -5.0F, -3.3F, -7.0F, 10, 5, 2, 0.0F, false));
        this.Pedestal.cubeList.add(new ModelBox(this.Pedestal, 2, 0, -8.0F, -3.8F, -5.999F, 16, 2, 12, 0.0F, false));
        this.Pedestal.cubeList.add(new ModelBox(this.Pedestal, 4, 14, -7.0F, -1.8F, -4.999F, 14, 2, 10, 0.0F, false));
        ...
        super.setTexture(new ResourceLocation("minidot", "pets/bedwars2022diamond.png"));
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/bedwars2022diamond_animation.json"));
    ...
    {
        return "\u0410\u043b\u043c\u0430\u0437\u043d\u0430\u044f \u043a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2022";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u043e\u0440\u0433\u0430\u043d\u0438\u0437\u0430\u0446\u0438\u044e \u0442\u0443\u0440\u043d\u0438\u0440\u0430 " + EnumChatFormatting.GREEN + "BedWars Hard [\u041b\u0435\u0442\u043e 2022]");
    }
}
