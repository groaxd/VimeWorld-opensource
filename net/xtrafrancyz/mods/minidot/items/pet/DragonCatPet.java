...
public class DragonCatPet extends BasePet
{
    private final MModelRenderer cat_dragon;
    ...
    public DragonCatPet()
    {
        ...
        this.cat_dragon = new MModelRenderer(this);
        this.body = new MModelRenderer(this);
        this.cat_dragon.addChild(this.body);
        this.body.cubeList.add(new ModelBox(this.body, 25, 21, -2.0F, -7.0F, -3.0F, 3, 2, 1, 0.0F, false));
        ...
        this.right_arm.cubeList.add(new ModelBox(this.right_arm, 26, 2, -0.5F, -1.25F, -1.0F, 2, 2, 2, 0.0F, true));
        this.left_arm = new MModelRenderer(this);
        this.left_arm.setRotationPoint(-4.0F, -4.0F, 1.0F);
        this.arms.addChild(this.left_arm);
        this.left_arm.cubeList.add(new ModelBox(this.left_arm, 26, 2, -1.5F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false));
        ...
        this.left_leg.cubeList.add(new ModelBox(this.left_leg, 20, 0, -1.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false));
        this.right_leg = new MModelRenderer(this);
        this.right_leg.setRotationPoint(1.25F, 0.0F, 1.0F);
        this.legs.addChild(this.right_leg);
        this.right_leg.cubeList.add(new ModelBox(this.right_leg, 20, 0, -1.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, true));
        ...
        this.right_ear.cubeList.add(new ModelBox(this.right_ear, 26, 6, -1.0F, -2.0F, 0.0F, 3, 3, 1, 0.0F, false));
        ...
        this.left_ear.cubeList.add(new ModelBox(this.left_ear, 8, 26, -2.0F, -2.0F, 0.0F, 3, 3, 1, 0.0F, false));
        ...
        this.left_wing.cubeList.add(new ModelBox(this.left_wing, 18, 20, 0.0F, -4.0F, 0.0F, 0, 8, 4, 0.0F, false));
        ...
        this.right_wing.cubeList.add(new ModelBox(this.right_wing, 18, 20, 0.0F, -4.0F, 0.0F, 0, 8, 4, 0.0F, false));
        this.tail = new MModelRenderer(this);
        this.tail.setRotationPoint(-0.5F, -1.0F, 4.0F);
        this.body.addChild(this.tail);
        this.tail.cubeList.add(new ModelBox(this.tail, 11, 17, -1.0F, -1.0F, -1.0F, 2, 2, 5, 0.0F, false));
        this.tail_end = new MModelRenderer(this);
        this.tail_end.setRotationPoint(0.0F, 0.0F, 4.0F);
        this.tail.addChild(this.tail_end);
        this.tail_end.cubeList.add(new ModelBox(this.tail_end, 0, 17, -1.0F, -1.0F, -4.0F, 2, 2, 7, -0.2F, false));
        ...
        this.tail_end1.cubeList.add(new ModelBox(this.tail_end1, 0, 22, 0.0F, -3.0F, 0.0F, 0, 4, 4, 0.0F, false));
        ...
        this.tail_end2.cubeList.add(new ModelBox(this.tail_end2, 20, 13, 0.0F, -3.0F, 0.0F, 0, 4, 4, 0.0F, false));
        this.horns = new MModelRenderer(this);
        this.body.addChild(this.horns);
        this.right_horn = new MModelRenderer(this);
        this.right_horn.setRotationPoint(1.0F, -11.0F, -2.0F);
        this.setRotation(this.right_horn, -0.829F, 0.0F, 0.0F);
        this.horns.addChild(this.right_horn);
        this.right_horn.cubeList.add(new ModelBox(this.right_horn, 0, 14, 0.0F, -7.0F, 0.0F, 0, 7, 3, 0.0F, true));
        this.left_horn = new MModelRenderer(this);
        this.left_horn.setRotationPoint(-2.0F, -11.0F, -2.0F);
        this.setRotation(this.left_horn, -0.829F, 0.0F, 0.0F);
        this.horns.addChild(this.left_horn);
        this.left_horn.cubeList.add(new ModelBox(this.left_horn, 0, 14, 0.0F, -7.0F, 0.0F, 0, 7, 3, 0.0F, false));
        super.setTexture(new ResourceLocation("minidot", "pets/dragoncatpet.png"));
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/dragoncatpet_animation.json"));
        this.animation = bbanimationloader.mustGet("dragoncatpet.animation", this);
    }
